...
#projections.append(p.Projection(populations[0], populations[1], p.OneToOneConnector(weights=baseline_excit_weight, delays=total_delay), target='excitatory2', synapse_dynamics=p.SynapseDynamics(slow=stdp_model)))
